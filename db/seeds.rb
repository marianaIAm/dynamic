...
accounts = Account.create([
  {
    email: "gabby@trainer.com",
    password: "gabbytrainer"
  },
  {
    email: "bella@trainer.com",
  ...
  },
  {
    ...
    password: "samanthaclient"
  },
  {
    email: "jack@client.com",
    password: "jackclient"
  },
  {
    email: "Roberta@client.com",
    password: "robertaclient"
  },
  {
    email: "edward@client.com",
    password: "edwardclient"
  }
])
...
clients = [
  ...
  Client.create(name_last: "Smith", name_first: "Roberta", phone: "310-333-3333", account_id: accounts[6].id, trainer_id: trainers[1].id, avatar: "https://s3.amazonaws.com/dynamic-build/avatar_female_red_1.png"),
